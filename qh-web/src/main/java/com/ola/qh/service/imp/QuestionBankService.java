			...
			if(userFinishlist.size()!=0){
				...
				for (QuestionBank questionBank : listbank) {
					for (QuestionBankUserFinish questionBankUserFinish : userFinishlist) {
						...
						if(questionBankUserFinish.getConditions()==0 && questionBank.getId().equals(questionBankUserFinish.getBankId())){
					...
					for (QuestionUnit questionUnit : listunit) {
						...
						for (QuestionBankUserFinish questionBankUserFinish : userFinishlist) {
							...
							if(questionBankUserFinish.getConditions()==1 && questionUnit.getId().equals(questionBankUserFinish.getBankId())){
