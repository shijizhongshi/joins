...
public interface CourseDao {
	...
	public CourseLineShow singleLiveShow(@Param("roomId") String roomId,@Param("liveId")String liveId);
	...
	public int updateLineCheck(@Param("courseTypeSubclassName") String courseTypeSubclassName,
			@Param("roomid") String roomid, @Param("updatetime") Date updatetime, @Param("id") String id);
	...
	public Integer selectCount(@Param("userId")String userId,@Param("liveId") String liveId);
