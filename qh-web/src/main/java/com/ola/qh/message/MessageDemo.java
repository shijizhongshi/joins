...
{
	////////安卓的appKey
    private static String appkey = "5c4286fcf1f556cba3000ef4";
    private static String appMasterSecret = "hn01kvcz0smafamdimo2trdvkctz91bj";
    ...
    {
	sendAndroidUnicast("测试通知", "测试通知","请查看通知", "Amz1gC1tLVJUwmoYfuM3-5LPObkk_m6q5OC4wNcN6cog");
