...
public final class Requests
{
    ...
    public static Results<byte[]> post(String url, Map<String, String> headers, Map<String, String> params, String json, Map<String, String> forms, File[] files, byte[] data)
    {
	Results<byte[]> result = new Results<byte[]>();
	if (Objects.nonNull(params) && !params.isEmpty())
	{
